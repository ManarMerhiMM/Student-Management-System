                        ...
                        <form method="POST" action="{{ route('login.attempt') }}">
                            ...
                            <div class="mb-3 position-relative">
                                ...
                                <img id="hidepass" src="{{ asset('Images/hidepass.png') }}" alt="Hide password"
                                    onclick="togglePass()"
                                    style="display: block; position: absolute; top: 57%; right: 6%; cursor: pointer; height: 24px;">

                                <img id="showpass" src="{{ asset('Images/showpass.png') }}" alt="Show password"
                                    onclick="togglePass()"
                                    style="display: none; position: absolute; top: 57%; right: 6%; cursor: pointer; height: 24px;">
